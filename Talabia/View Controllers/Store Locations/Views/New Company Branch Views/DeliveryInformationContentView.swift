...
class DeliveryInformationContentView: BasicViewWithSetup, InputCardViewType {
    ...
    var cities: [CityItem] {
        deliveryAreaInputView.selectedCities
    }
...
class DeliveryAreaInputView: BasicViewWithSetup {
    ...
    func presentPicker(){
        ...
        cityPickerViewController?.selectionMode = .multiple
        cityPickerViewController?.selectedOptions = Set(selectedCities)
