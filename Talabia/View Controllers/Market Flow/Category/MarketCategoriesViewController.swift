...
class MarketCategoriesViewController: ContentViewController<[MainCategory]>, UICollectionViewDataSource, UICollectionViewDelegate  {
    ...
    override func setupViewsBeforeTransitioning() {
        ...
        collectionView.leading(15).trailing(15).top(0).bottom(0)
...
extension MarketCategoriesViewController {
    ...
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        unwrappedContent[section].subcategories?.count ?? 0
    }
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let category = unwrappedContent[indexPath.section].subcategories?[indexPath.item]
    ...
    func collectionView(_ collectionView: UICollectionView, viewForSupplementaryElementOfKind kind: String, at indexPath: IndexPath) -> UICollectionReusableView {
        ...
        let category = unwrappedContent[indexPath.section]
...
extension MarketCategoriesViewController {
    ...
    func generateLayout() -> UICollectionViewLayout {
        ...
        let boundaryItemSize = NSCollectionLayoutSize(widthDimension: .fractionalWidth(0.956),
