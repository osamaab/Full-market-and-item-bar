...
struct CLRegisterationSectionListProvider: CLScreenSectionListProvider {
    ...
    let operations: CLScreensSection = {
        let screenClasses = [
            BaseOrdersListViewController.self,
            BaseOrderDetailsViewController.self,
        ]
    ...
    let distributors: CLScreensSection = {
        let screenClasses = [
            DistributorsListViewController.self,
            NewDistributorViewController.self,
