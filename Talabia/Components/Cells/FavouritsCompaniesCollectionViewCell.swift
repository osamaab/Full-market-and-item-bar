//
//  FavouritsCompaniesCollectionViewCell.swift
//  Talabia
//
...
import UIKit
import Stevia
class FavouritsCompaniesCollectionViewCell: UICollectionViewCell {
    ...
    func setup() {
        ...
        imageView.top(12).centerHorizontally()
        imageView.height(70%).width(100%).centerHorizontally()
