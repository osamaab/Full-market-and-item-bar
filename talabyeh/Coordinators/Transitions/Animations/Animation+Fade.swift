...
extension Animation {
    ...
    static let fadeInstant = Animation(
        presentation: InteractiveTransitionAnimation.fadeInstant,
        dismissal: InteractiveTransitionAnimation.fadeInstant)
}
...
extension InteractiveTransitionAnimation {
    ...
    fileprivate static let fadeInstant = InteractiveTransitionAnimation(duration: defaultAnimationDuration) { transitionContext in
        let containerView = transitionContext.containerView
        let toView = transitionContext.view(forKey: .to)!
