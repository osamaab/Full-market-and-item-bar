...
class ProfilePageView: UIView {
    ...
    final private func defaultLayout()
    {
        ...
        nameLabel.font = LanguageManager.shared.currentLanguage == .en ? getEnglishFont(22, .semiBold) : getArabicFont(22, .heavy)
        ...
        emailLabel.font = LanguageManager.shared.currentLanguage == .en ? getEnglishFont(16, .semiBold) : getArabicFont(16, .heavy)
        ...
        phoneNumberLabel.font = LanguageManager.shared.currentLanguage == .en ? getEnglishFont(13, .medium) : getArabicFont(13, .regular)
