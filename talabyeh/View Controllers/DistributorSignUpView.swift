...
//                self.contentTableViewCell.subviews(personalDistributorView)
    ...
    let emailtfpersonal = CustomTextField()
    let passwordtfpersonal = CustomTextField()
    
    let firstNametf = CustomTextField()
    let passwordtf = CustomTextField()
    let emailtf = CustomTextField()
    let mobileNumbertf = CustomTextField()
    let carType = CustomTextField()
    ...
    final private func defaultLayout(){
        ...
        firstNametf.font = LanguageManager.shared.currentLanguage == .ar ? getArabicFont(16, .regular) : getEnglishFont(16, .medium)
        ...
        mobileNumbertf.font = LanguageManager.shared.currentLanguage == .ar ? getArabicFont(16, .regular) : getEnglishFont(16, .medium)
        ...
        carType.font = LanguageManager.shared.currentLanguage == .ar ? getArabicFont(16, .regular) : getEnglishFont(16, .medium)
