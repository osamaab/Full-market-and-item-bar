...
class CompanyBranchCollectionViewCell: UICollectionViewCell {
    ...
    func setup(){
        ...
        titleLabel.text = "Amman 1"
        subtitleLabel.text = "Full Adress Full Adress Full Adress Full Adress Full"
        ...
        summaryLabel.text = "Available for Delivery\nFree Delivery\nDelivered to: Amman, Petra, Aqaba"
    }
